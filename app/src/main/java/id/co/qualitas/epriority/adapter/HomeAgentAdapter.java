...
public class HomeAgentAdapter extends RecyclerView.Adapter<HomeAgentAdapter.ViewHolder> {

    private final List<Booking> bookings;
    private HomeAgentFragment mContext;

    public HomeAgentAdapter(HomeAgentFragment mContext, List<Booking> bookings) {
    ...
    public void onBindViewHolder(@NonNull HomeAgentAdapter.ViewHolder holder, int position) {
        ...
        if(booking.status.equals(mContext.getString(R.string.pending))){
